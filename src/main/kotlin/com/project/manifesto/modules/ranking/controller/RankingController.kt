...
class RankingController(
    ...
    fun getHot(
        ...
        val result = rankingService.getHotPosts(PageRequest.of(page, size))
    ...
    fun getNew(
        ...
        val result = rankingService.getNewPosts(PageRequest.of(page, size))
        return ResponseEntity.ok(ApiResponse.success(result))
    }
    ...
    fun getTop(
        ...
        val result = rankingService.getTopPosts(PageRequest.of(page, size))
        return ResponseEntity.ok(ApiResponse.success(result))
    }
}
