...
class VoteE2ETest
    ...
    constructor(
        ...
        fun `upvote count increments, remove decrements`() {
            ...
            mockMvc
                .post("/api/v1/posts/$postId/upvote") { header("Authorization", "Bearer $tokenA") }
                .andExpect { status { isOk() } }
            mockMvc
                .post("/api/v1/posts/$postId/upvote") { header("Authorization", "Bearer $tokenB") }
                .andExpect { status { isOk() } }
            ...
            mockMvc
                .delete("/api/v1/posts/$postId/upvote") { header("Authorization", "Bearer $tokenA") }
                .andExpect { status { isOk() } }
