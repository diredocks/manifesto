...
class ModerationE2ETest
    ...
    constructor(
        ...
        fun `moderator can delete any comment`() {
            ...
            mockMvc
                .delete("/api/v1/moderator/comments/$commentId") {
        ...
        fun `admin can list users and change roles`() {
            ...
            mockMvc
                .put("/api/v1/admin/users/${plainUser.id}/role") {
                    header("Authorization", "Bearer $adminTokenFresh")
        ...
        fun `moderator can ban and unban a user`() {
            ...
            mockMvc
                .post("/api/v1/moderator/users/${target.id}/ban") {
                    header("Authorization", "Bearer $modToken")
            ...
            mockMvc
                .delete("/api/v1/moderator/users/${target.id}/ban") {
                    header("Authorization", "Bearer $modToken")
                }.andExpect {
                    status { isOk() }
        ...
        fun `moderator cannot ban an admin`() {
            ...
            mockMvc
                .post("/api/v1/moderator/users/${adminUser.id}/ban") {
                    header("Authorization", "Bearer $modToken")
                    param("durationHours", "24")
